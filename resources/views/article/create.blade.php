...
<div class="container">
    <div class="row justify-content-center">   
        <h1 class="pt-5">{{ __("lang.forum_create_title") }}</h1>
        <p>{{ __("lang.forum_create_intro") }}</p>
        <form action="{{ route('article.create') }}" method="POST" class="py-5">
            @csrf
            @if ($errors->any())
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="fr" role="tabpanel" aria-labelledby="fr-tab">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="contenu" name="contenu" novalidate>{{ old('contenu') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="contenu_en" name="contenu_en" novalidate>{{ old('contenu_en') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
