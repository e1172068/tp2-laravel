    ...
    <div class="row justify-content-center">   
        ...
        <form action="" method="POST" class="py-5">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="adresse" name="adresse" value="<?php echo e(old('adresse')); ?>">
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <input type="date" class="form-control" id="date_naissance" name="date_naissance" value="<?php echo e(old('date_naissance')); ?>">
                </div>
            </div>
            <div class="row mb-3">
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\e1172068\Desktop\maisonneuve-e1172068\resources\views/etudiant/create.blade.php ENDPATH**/ ?>