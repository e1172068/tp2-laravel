...
<div class="container">
    <div class="row justify-content-center">   
        <h1 class="pt-5"><?php echo e(__("lang.forum_create_title")); ?></h1>
        <p><?php echo e(__("lang.forum_create_intro")); ?></p>
        <form action="<?php echo e(route('article.create')); ?>" method="POST" class="py-5">
            <?php echo csrf_field(); ?>
            <?php if($errors->any()): ?>
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="fr" role="tabpanel" aria-labelledby="fr-tab">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="contenu" name="contenu" novalidate><?php echo e(old('contenu')); ?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="contenu_en" name="contenu_en" novalidate><?php echo e(old('contenu_en')); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\e1172068\Desktop\maisonneuve-e1172068\resources\views/article/create.blade.php ENDPATH**/ ?>