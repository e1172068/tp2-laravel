...
<div class="container">
    <div class="row justify-content-center">
        <h1 class="pt-5">Formulaire de modification d'étudiant</h1>
        <form action="" method="POST" class="py-5">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <input type="email" class="form-control" id="email" name="email" value="<?php echo e($etudiant->email); ?>">
                </div>
            </div>
            <div class="row mb-3">
                <label for="date_naissance" class="col-sm-3 col-form-label">Date de naissance</label>
                <div class="col-sm-9">
                    <input type="date" class="form-control" id="date_naissance" name="date_naissance" value="<?php echo e($etudiant->date_naissance); ?>">
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="d-flex justify-content-end py-2 button-container">
                <a type="button" href="<?php echo e(route('etudiant.show', $etudiant)); ?>" class="btn btn-secondary">Retour</a>
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\stngm\Desktop\maisonneuve-e1172068\resources\views/etudiant/edit.blade.php ENDPATH**/ ?>